              ...
              <div className="flex items-center space-x-6">
                <Link to="/profile">
                  ...
                  >
                    ...
                    {/* popup box  */}
                    {isHovered && (
                      <div className="absolute left-1/2 transform -translate-x-1/2 mb-3 w-64 max-w-xs bg-white text-gray-800 px-5 py-3 rounded shadow-lg z-10 transition-opacity duration-300 ease-in-out animate-fade-in">
                        <p className="text-sm font-medium">
                          this is popup box on hover
                        </p>
                      </div>
                    )}
                  </div>
