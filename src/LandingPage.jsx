    ...
    <div className="bg-[url('./landingpage-bg.jpg')] bg-cover bg-center h-screen m-0">
      <div className="p-5 ">
        ...
        <p className="text-lg px-5 w-[60%]">
          ...
          delivering high-quality accounting tailored to meet the evolving needs
          of our clients. Established in 2023, our company has grown into a
          trusted name in the accounting sector, driven by innovation,
          ...
          and enrich lives, while maintaining sustainable practices and
        ...
        <p className="text-lg px-5 w-[60%]">
          ...
          inspiration, information, or innovative solutions, you’ve come to the
          right place. Explore our content, learn something new, and let us know
          how we can help you get the most out of your visit.
        </p>
      </div>
    </div>
  );
