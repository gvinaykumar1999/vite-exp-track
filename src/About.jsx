        ...
        <div className="bg-[url('./aboutpage.jpg')] w-full h-screen">
          ...
          <div className="p-5">
            ...
            <p className=" p-5 w-[50%] text-xl">
              Our website provides practical, easy-to-understand financial
              advice for young adults, helping them make smart money decisions
            ...
            <p className="text-xl">
              <span className="font-bold">Benefit: </span>Clear, actionable
          ...
          <div className="p-5">
            ...
            <p className=" p-5 w-[50%] text-xl">
              Welcome to GreenSprout! We believe that living sustainably
              shouldn't be a sacrifice, but a fulfilling journey. Frustrated by
              the overwhelming amount of information out there, we created
              GreenSprout to provide practical tips, inspiring stories, and
              reliable resources for anyone looking to make eco-conscious
            ...
            <p className=" pl-5 pt-0 w-[50%] text-xl">
              ...
              cultivate a greener future together. Explore our latest articles
